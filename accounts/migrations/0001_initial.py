    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('perfil', models.IntegerField(choices=[(1, 'Administrador'), (2, 'Usuario'), (3, 'Recepcionista')])),
                ('avatar', models.ImageField(blank=True, help_text='Imagen de perfil del usuario.', null=True, upload_to=accounts.helpers.avatar_path)),
